...
```{r}
medals <- read_delim("Dataset/Medals.csv", delim=";")

medals_cor <- cor(na.omit(select(medals, -c("Team", "Rank by Total", "Rank", "Total"))))

ggcorrplot(medals_cor, type = "lower", lab = TRUE)
