...
ggplot(aggreg_dati_italia, aes(x = n_ath, y = t_diff, color = factor(ifelse(Year %in% c(1932, 1960, 1984, 2020),
        "Highlighted","Normal")))) +
  scale_color_manual(values = c("Highlighted" = "#EE334E", "Normal" = "#000000"), na.value = "#F0F0F0") +
  xlab("Numero atleti Italia Team") +
...
**Bassa correlazione**. Indice di correlazione lineare : 0.1506913
...
**Bassa correlazione**. Indice di correlazione lineare : -0.0195657
